...
Q_CONSTINIT static const qt_meta_stringdata_CameraWindow_t qt_meta_stringdata_CameraWindow = {
    {
        ...
        QT_MOC_LITERAL(13, 34),  // "on_cameraCombo_currentIndexCh..."
        QT_MOC_LITERAL(48, 0),  // ""
        QT_MOC_LITERAL(49, 5),  // "index"
        QT_MOC_LITERAL(55, 22),  // "on_startButton_clicked"
        QT_MOC_LITERAL(78, 21)   // "on_stopButton_clicked"
    },
    "CameraWindow",
    "on_cameraCombo_currentIndexChanged",
    "",
    "index",
...
Q_CONSTINIT const QMetaObject CameraWindow::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CameraWindow_t,
        ...
        // method 'on_cameraCombo_currentIndexChanged'
...
void CameraWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->on_cameraCombo_currentIndexChanged((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
